...
<script>
    ...
    if(msg=="Error")   alert("삭제되었거나 없는 게시물입니다.");

    if(msg=="Complete")    alert("성공적으로 삭제되었습니다.");
        ...
        <div class="search-container">
            <form action="<c:url value="/board/list"/>" class="search-form" method="get">
                <select class="search-option" name="option">
                    ...
                    <option value="T" ${ph.searchCondition.option=='T' ? "selected" : ""}>제목만</option>
        ...
        <table>
            ...
            <c:forEach var="boardDto" items="${list}">
                <tr>
                    ...
                    <td class="title"><a href="<c:url value="/board/read${ph.searchCondition.queryString}&bno=${boardDto.bno}"/>"><c:out value='${boardDto.title}'/></a></td>
